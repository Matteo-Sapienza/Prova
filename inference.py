...
parser.add_argument('--face', type=list, help='Filepath of video/image that contains faces to use', required=True)

parser.add_argument('--audio', type=list, help='Filepath of video/audio file to use as raw audio source', required=True)
...
def main():
	mel_chunks = args.audio
	full_frames = args.face
	fps = args.fps
